...
- Active prefecture: Hokuriku
- Review rows retained after POI-prefecture filter: 4956
- Chinese posts retained: 243
- Statistical tests output: `output/cross_language_trends_hokuriku/cross_language_statistical_tests.csv`
...
- Chinese (SnowNLP) sentiment categories are unvalidated on short text: ~79% of Chinese 'negative' rows are 4-5 star, so the Chinese negative_pct and category shares are NOT interpretable as sentiment and are retained only as a descriptive, non-confirmatory artifact.
